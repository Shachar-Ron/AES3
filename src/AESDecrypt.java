...
public class AESDecrypt {
    ...
    public  AESDecrypt(String keysPath, String inputFilePath, String outputFilePath) {
        this.outputFilePath = outputFilePath;
        state = new byte[Nb][Nb];
        byte[] keys =  readFileskeyPath(keysPath);
        initKeys(keys);
        readFilesinputFilePath(inputFilePath);
        messageAsNby4Matrix = convertplainText2(cipherText);
    }
    //----------------------------------------------------------------------------------
